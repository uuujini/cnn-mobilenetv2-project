...
def build_and_train_model():
    ...
    train_data = load_data('train', augment=True)
    ...
    # Log file
    log_file_path = '../mobile-net/MobileNetV2_CustomModel_history.txt'
    ...
    tf.saved_model.save(model, 'saved_model_MobileNetV2_CustomModel')
